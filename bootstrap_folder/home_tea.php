    ...
    <body id="page-top">
        ...
        <a class="menu-toggle rounded" href="#"><i class="fas fa-bars"></i></a>
            <nav id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-nav-item"><a href="./PHP/problem_form.php">Add a Problem</a></li>
                </ul>
        ...
        <header class="masthead d-flex align-items-center">
            <div class="container px-4 px-lg-5 text-center">
                ...
                <a class="btn btn-primary btn-xl" href="./PHP/prob_landing.php">View Problems</a>
                <a class="btn btn-secondary btn-xl ms-3" href="PHP/problem_form.php">New Problem</a>
